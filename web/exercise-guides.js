...
// Curated YouTube video IDs and technique metadata keyed by lowercase normalized names.
...
window.GRAVITAS_GUIDES = {
  ...
  "close-grip lat pulldown": {
    ...
    benchAngle: null,
    setup: [
        "V-bar attachment use karo.",
        "Narrow neutral grip."
    ],
    execution: [
        "Upper abs/sternum tak pull karo.",
        "Squeeze karo, release karo."
    ],
    dos: [
        "Lower lats aur inner back feel karo."
    ],
    donts: [
        "Lean zyada mat karo.",
        "Swing mat karo."
  ...
  "seated cable row": {
    ...
    dos: [
        "Upright posture rako during pull.",
        "Full stretch lo starting position mein."
    ],
    donts: [
        "Zyada lean mat karo forward ya backward.",
        "Jerk mat karo."
    ]
  },
  "chest-supported row": {
    ...
    donts: [
        "Neck ko strain mat karo.",
        "Hips ko bench se mat uthaao."
    ]
  },
  "face pull": {
    ...
    dos: [
        "Light weight use karo — form se karo.",
        "Elbows upar maintain karo pull mein."
    ],
    donts: [
        "Heavy weight mat lao — injury risk.",
        "Arms ko down pull mat karo."
    ]
  },
  ...
  "leg extension": {
    ...
    dos: [
        "Peak contraction pe 1–2 second hold karo.",
        "Slow eccentric (lowering) use karo."
    ],
    donts: [
        "Hips ko seat se mat uthaao.",
        "Momentum se jhatak ke mat karo."
    ]
  },
  "romanian deadlift": {
  ...
  "seated leg curl": {
    ...
    dos: [
        "Full ROM use karo.",
        "Toes neutral ya slightly pointed rakho."
    ],
    donts: [
        "Hips ko seat se mat uthaao.",
        "Jerk mat karo."
  ...
  "bulgarian split squat": {
    ...
    dos: [
        "Front leg quad aur glute feel karo.",
        "Core tight rakho throughout."
    ],
    donts: [
        "Front knee inward mat hone do.",
        "Zyada heavy weight na lo start mein."
    ]
  },
  "barbell hip thrust": {
    ...
    dos: [
        "Chin ko chest se touch karo — neck neutral.",
        "Full hip extension lo top pe."
    ],
    donts: [
        "Ribs ko flare mat karo.",
        "Knees inward mat hone do."
    ]
  },
  "standing calf raise": {
    ...
    dos: [
        "Full ROM — stretch aur contraction dono.",
        "Slow, controlled reps karo."
    ],
    donts: [
        "Bounce mat karo neeche se.",
        "Knees bend mat karo."
    ]
  },
  "seated calf raise": {
    ...
    dos: [
        "Soleus muscle feel karo — deep inner calf.",
        "Slow reps use karo."
    ],
    donts: [
        "Bounce mat karo.",
        "Knees ko upar mat uthaao."
    ]
  },
  "barbell overhead press": {
    ...
    donts: [
        "Lower back arch mat karo zyada.",
        "Bar ko forward path pe mat press karo."
    ]
  },
  "seated dumbbell press": {
    ...
    donts: [
        "Elbows flare mat karo zyada.",
        "Jerky motion mat karo."
    ]
  },
  "dumbbell lateral raise": {
    ...
    dos: [
        "Light weight — form se karo.",
        "Pause karo top pe."
    ],
    donts: [
        "Momentum se mat swing karo.",
        "Ears tak zyada upar mat jao."
    ]
  },
  "cable lateral raise": {
    ...
    dos: [
        "Constant tension is key — cable dumbbell se better hai.",
        "Unilateral karo aur both sides pe equal focus."
    ],
    donts: [
        "Heavy weight mat lo — form toot jayega.",
        "Torso mat jhukao."
    ]
  },
  "reverse pec deck": {
    ...
    dos: [
        "Elbow bend fixed rakho.",
        "Light weight — rear delts weak muscle hai."
    ],
    donts: [
        "Neck ko strain mat karo.",
  ...
  "barbell shrug": {
    ...
    dos: [
        ...
        "Full contraction feel karo."
    ],
    donts: [
        "Shoulders ko roll mat karo — injury risk.",
        "Neck ko bend mat karo."
    ]
  },
  "dumbbell shrug": {
  ...
  "barbell curl": {
    ...
    dos: [
        "Elbows fix karo — anchor point.",
        "Full extension lo neeche."
    ],
    donts: [
        "Body swing mat karo.",
        "Elbows aage mat laao curling mein."
    ]
  },
  "incline dumbbell curl": {
    ...
    donts: [
        "Shoulder ko aage mat laao — arm back pe hang karo.",
        "Swing mat karo."
    ]
  },
  "hammer curl": {
    ...
    dos: [
        "Brachialis aur brachioradialis target hota hai.",
        "Wrist neutral rakho throughout."
    ],
    donts: [
        "Palms ko rotate mat karo — neutral grip fixed.",
        "Swing mat karo."
    ]
  },
  "preacher curl": {
    ...
    dos: [
        "Strict form — pad se arm ko mat uthaao.",
        "Slow reps — cheating possible nahi."
    ],
    donts: [
        "Heavy weight mat lo — elbow joint stress.",
        "Elbows ko pad se mat uthaao."
    ]
  },
  "rope pushdown": {
    ...
    dos: [
        "Elbows tucked aur fixed.",
        "Peak contraction pe rope split karo."
    ],
    donts: [
        "Elbows mat hone do swing — anchor karo.",
        "Forward lean zyada mat karo."
    ]
  },
  ...
  "overhead cable extension": {
    ...
    dos: [
        "Long head maximum stretch milti hai is angle pe.",
        "Elbows narrow rakho throughout."
    ],
    donts: [
        "Elbows flare mat karo.",
        "Jerk mat karo."
    ]
  },
  "tricep dips": {
    ...
    dos: [
        "Controlled descent.",
        "Forward lean = more chest; upright = more tricep."
    ],
    donts: [
        "Zyada neeche mat jao — shoulder injury.",
        "Flare mat karo elbows."
    ]
  },
  "skull crushers": {
    ...
    dos: [
        "Elbows narrow rakho throughout.",
        "Controlled — bar gira to sach mein skull crush."
    ],
    donts: [
        "Elbows flare mat karo.",
  ...
  "cable crunch": {
    ...
    dos: [
        "Hip movement minimize karo — abs se karo.",
        "Full ROM — stretch feel karo."
    ],
    donts: [
        "Arms se pull mat karo — abs se move karo.",
        "Hip hinge mat karo."
    ]
  },
  "plank": {
    ...
    dos: [
        "Glutes aur quads tight rakho.",
        "Breathing maintain karo."
    ],
    donts: [
        "Hips ko sag mat hone do.",
        "Head drop mat karo ya upar mat karo."
    ]
  },
  "hanging leg raise": {
    ...
    dos: [
        "Swing minimize karo.",
        "Bent knee se shuru karo agar advanced nahi."
    ],
    donts: [
        "Momentum se mat swing karo.",
        "Lower back se arch mat karo."
    ]
  },
  "russian twist": {
    ...
    dos: [
        "Rotation torso se karo, na arms se.",
        "Feet lifted for more challenge."
    ],
    donts: [
        "Lower back pe stress mat do — neutral spine.",
        "Zyada fast mat karo — controlled."
    ]
  },
  "decline sit-up": {
    ...
    dos: [
        "Slow movement karo — momentum se mat.",
        "Full crunch motion lo."
    ],
    donts: [
        "Neck se mat pull karo — haath head ke peeche hai to release karo.",
        "Jerk mat karo."
    ]
  },
  "ab wheel rollout": {
    ...
    dos: [
        ...
        "Core tight rakho — lower back protect karo."
    ],
    donts: [
        "Hips ko sagging mat hone do.",
        "Beginners full extension mat karo."
    ]
  },
  "treadmill running": {
    ...
    dos: [
        "Incline 1–2% rakho — outdoor running simulate karta hai.",
        "Hydrated raho."
    ],
    donts: [
        "Handrails mat pakdo — it defeats the purpose.",
        "Start mein zyada fast mat jao."
    ]
  },
  "stationary bike": {
    ...
    dos: [
        "Consistent cadence maintain karo.",
        "HIIT ya steady state — both effective."
    ],
    donts: [
        "Zyada neeche seat mat rakho — knee strain.",
        "Handlebars pe zyada lean mat karo."
    ]
  },
  "rowing machine": {
    ...
    dos: [
        "Sequence: Legs → Body → Arms. Recovery: Arms → Body → Legs.",
        "Smooth continuous movement."
    ],
    donts: [
        "Arms pehle mat kheincho — legs first.",
        "Round back mat karo."
    ]
  },
  "battle ropes": {
    ...
    dos: [
        ...
        "Multiple wave patterns try karo."
    ],
    donts: [
        "Only arms mat use karo — full body involvement.",
        "Straight legs mat rakho."
    ]
  },
  "kettlebell swing": {
    ...
    donts: [
        "Lower back se mat karo — hips se karo.",
        "Arms se lift mat karo — hip power use karo."
    ]
  },
  "thruster": {
    ...
    dos: [
        "Squat aur press ek seamless movement mein.",
        "Core tight throughout."
    ],
    donts: [
        "Squat aur press separately mat karo — combine karo power.",
        "Elbows mat girane do."
    ]
  },
  "bayesian curl": {
    youtubeId: "5141eKzXpW0",
    benchAngle: null,
    setup: [
        "Cable pulley ko low level height pe set karein.",
        "Single handle (D-handle) attachment lagayein.",
        "Handle pakdo aur machine ke opposite direction me step aage lo, shoulder line arm neutral deep stretch position me ho."
    ],
    execution: [
        "Elbow ko shoulder line ke thoda peeche fix rakhein aur weights upar curl karein.",
        "Peak extension range pe tight squeeze hold karein.",
        "Low down negative stretch control speed ke sath wapas target control position pe laayein."
    ],
    dos: [
        "Elbow back alignment steady fixed rakhein.",
        "Positive and negative flow strictly muscle contract tension focus targets."
    ],
    donts: [
        "Body swing bilkul use na karein.",
        "Wrist ko lock rakhein, excessive curl dynamic avoid karein."
    ]
  },
  "single-arm cable pushdown": {
    youtubeId: "K451G4TjC7w",
    benchAngle: null,
    setup: [
        "Cable pulley stack ko dynamic high level height pe adjust karein.",
        "Single-grip handle attach karein aur standard stance side stable set range."
    ],
    execution: [
        "Elbow body range close secure rakhein aur handle ko down drag stretch line lockout extension drive karein.",
        "Bottom range lockout contraction peaks triceps feel squeeze.",
        "Controlled rate slow recovery rate keep focus dynamic static."
    ],
    dos: [
        "Wrists line natural rigid secure align.",
        "Maintain active core stability support."
    ],
    donts: [
        "Shoulder drops forward push force assist cheating avoid.",
        "Avoid wrist flexing."
    ]
  },
  "cable curl": {
    youtubeId: "AsDP00c4zCI",
    benchAngle: null,
    setup: [
        "Low pulley system set straight bar hook connect hook.",
        "Underhand shoulder width width grip stance standing upright."
    ],
    execution: [
        "Elbow anchor locking upar weight curl dynamic extension.",
        "Hold squeeze slow eccentric phase."
    ],
    dos: [
        "Constant tension pull control active flow."
    ],
    donts: [
        "Torso back swinging cheat sets prevent."
    ]
  },
  "cable hammer curl": {
    youtubeId: "PZ_d-rLd23c",
    benchAngle: null,
    setup: [
        "Low cable hook rope grip setup standing flat.",
        "Neutral thumb up grip rope grab."
    ],
    execution: [
        "Curl dynamic vertical elbows tight sides range.",
        "Squeeze brachi / forearm top split hold."
    ],
    dos: [
        "Peak range pull separate ropes twist outward."
    ],
    donts: [
        "Elbows flare forward motion avoid."
    ]
  },
  "high cable curl (hercules curl)": {
    youtubeId: "yq1QO_L9Gnk",
    benchAngle: null,
    setup: [
        "Dono sides cable crossover high pulleys standard handles grab.",
        "Step exact center hold position T stance posture."
    ],
    execution: [
        "Slow curl sideways handles target direction of ears.",
        "Keep upper arms static parallel horizontal floor."
    ],
    dos: [
        "Focus symmetry squeeze squeeze bicep peak heads."
    ],
    donts: [
        "Avoid drooping elbow levels lower than shoulder heights."
    ]
  },
  "lying cable curl": {
    youtubeId: "iH6Ua7J5_h4",
    benchAngle: null,
    setup: [
        "Low pulley bar setup.",
        "Lay flat face up floor mats feet straight machine line."
    ],
    execution: [
        "Hold bar underhand pull curl up face direction.",
        "Squeeze bicep, down control."
    ],
    dos: [
        "Strict form zero back swing possible."
    ],
    donts: [
        "Do not raise upper back off the floor."
    ]
  },
  "concentrated cable curl": {
    ...
    benchAngle: null,
    setup: [
        "Low pulley handle single grab.",
        "Seated or kneeling body frame support focus arm."
    ],
    execution: [
        "Curl focus inner knee stabilizer static isolate bicep peak.",
        "Squeeze hold peak tension return slow."
    ],
    dos: [
        "Keep body position rigid isolate target head."
    ],
    donts: [
        "Cheating avoid, light weights recommended."
    ]
  }
};

// Helper: Get guide for an exercise. Returns null if not found.
window.getExerciseGuide = function(exerciseName) {
  if (!exerciseName) return null;
  return window.GRAVITAS_GUIDES[exerciseName.toLowerCase().trim()] || null;
};
